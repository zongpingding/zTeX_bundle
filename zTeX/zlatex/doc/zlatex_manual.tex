...
The \LaTeX{} Companion(3rd) -- Font Selection and Encodings. 关于关于字体设置, 可以参见仓库文件:
\cmd[F]{Material/reference/TLC-FONT_SELECTION_AND_ENCODINGS.pdf}
