...
\begin{tikzpicture}[
  ...
  \Tree
    [.\node[normalKey] {z\LaTeX{} Options};
      ...
      [.\node[normalKey] {hyper-suppress}; \deft{toc} ]
      [[.\node[normalKey] {lang}; 
      ...
      [[.\node[metaKey] {sect}; 
        [.\node[boolKey] {load}; \deft{true} ]
        [.\node[normalKey] {style}; ]
        [.\node[boolKey] {dump-ptable}; \deft{false}  ]
      ]]
      [[[[.\node[metaKey] {layout}; 
        [.\node[boolKey]   {margin}; \deft{false} ]
        [.\node[boolKey]   {slide}; \deft{false}  ]
        [.\node[normalKey] {theme};  ]
