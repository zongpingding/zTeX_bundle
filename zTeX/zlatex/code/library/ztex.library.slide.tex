\ProvidesExplFile{ztex.library.slide.tex}{2025/05/05}{1.0.1}{slide~library~for~ztex}


%%%%%     slide library for ztex     %%%%%
\bool_gset_true:N \g__ztex_slide_bool
% ==> slide initialization
\exp_args:NNnx \seq_set_split:Nnn \l_tmpa_seq {|}{\g__ztex_aspectratio_tl}
  ...
  {\Large}{}{0pt}
  {
    \AddToHookNext{shipout/foreground}{
      \put(\dim_use:c {g_zslide_status_info_sec_L_dim}, \dim_use:c {g_zslide_status_info_sec_B_dim}){\Large
        \textcolor{\tl_use:N \l__ztex_slide_sec_fg_tl}{
          \tl_use:N \l__ztex_slide_sec_prefix_tl #1
...
\AddToHook{shipout/background}{
  \zslide_status_bar:nnnn {UL}{(0,              -\dim_use:c {g_zslide_status_bar_head_H_dim})}{.5}{\dim_use:c {g_zslide_status_bar_head_H_dim}}
  \zslide_status_bar:nnnn {UR}{(.5\paperwidth,  -\dim_use:c {g_zslide_status_bar_head_H_dim})}{.5}{\dim_use:c {g_zslide_status_bar_head_H_dim}}
  \zslide_status_bar:nnnn {BL}{(0,              -\paperheight)}{.33}{\dim_use:c {g_zslide_status_bar_foot_H_dim}}
  \zslide_status_bar:nnnn {BC}{(.33\paperwidth, -\paperheight)}{.34}{\dim_use:c {g_zslide_status_bar_foot_H_dim}}
  \zslide_status_bar:nnnn {BR}{(.67\paperwidth, -\paperheight)}{.33}{\dim_use:c {g_zslide_status_bar_foot_H_dim}}
...
\ztex_keys_define:nn { slide }{
  ...
  toc / label / chapter         .initial:n = { \zslidetoc@labelset[.25em]{\thecontentslabel.} },
  toc / label / section         .tl_set:N  = \l__ztex_slide_toc_label_section_tl,
  toc / label / section         .initial:n = { \zslidetoc@labelset[.25em]{\zslidetoc@sicon} },
  toc / label / subsection      .tl_set:N  = \l__ztex_slide_toc_label_subsection_tl,
  toc / label / subsection      .initial:n = { \zslidetoc@labelset[.5em]{\zslidetoc@ssicon} },
...
\NewDocumentCommand{\zslidelogo}{om}
  {
    ...
    \ztex_page_annotate:eeenn 
      {background}
      {\exp_after:wN \__page_mask@pos_parse:w \g__ztex_slide_logo_position_tl}
      {rb}{
...
\let\zslidetoc@page\contentspage
% bug: can NOT alias for command:'\thecontentslabel'
\NewDocumentCommand{\zslidetoc@labelset}{om}{
...
\clist_map_inline:nn {chapter, section, subsection}{
  \titlecontents{#1}
    [\dim_use:c {l__ztex_slide_toc_leftmargin_#1_dim}]
    {}{\tl_use:c {l__ztex_slide_toc_label_#1_tl}}
    {}{\tl_use:c {l__ztex_slide_toc_suffix_#1_tl}}
}
