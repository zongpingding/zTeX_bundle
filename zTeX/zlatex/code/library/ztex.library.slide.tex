\ProvidesExplFile{ztex.library.slide.tex}{2025/05/09}{1.0.1}{slide~library~for~ztex}
...
\cs_new:Npn \__zslide_chr_if_chinese:n #1#2#3
  {
    \ifnum`#1>19968
      #2
    \else
...
\titleformat{\section}
  {\Large}{}{0pt}
  {
    \__zslide_status_info_sec_coffin_typeset:o {#1}
  }[
