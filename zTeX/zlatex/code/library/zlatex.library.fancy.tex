\ProvidesExplFile{zlatex.library.fancy.tex}{2025/02/04}{1.0.1}{fancy~library~for~zlatex}


%%%%%     fancy library for zlatex     %%%%%
\bool_gset_true:N \g__zlatex_fancy_bool
% ==> handle fancy option
    ...
    {20pt}{
      \begin{tikzpicture}[overlay, remember~ picture]%
        ...
        \node[anchor=south, color=white] at ($(stripES)+(-1.5em, 0em)$)
          {\normalsize\scalebox{4}{\thechapter}\zlatexNumSuffix{\thechapter}};
