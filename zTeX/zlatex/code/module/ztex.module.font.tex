\ProvidesExplFile{ztex.module.font.tex}{2025/05/02}{1.0.1}{font~module~for~ztex}
...
\ztex_keys_define:nn { fontcfg / new }
  {
    ...
    % feat / AutoFakeBold    .tl_set:N   = \l__ztex_fontcfg_new_autofbd_tl,
    % feat / AutoFakeBold    .default:n  = { true },
    % feat / AutoFakeBold    .initial:n  = { false }, % false
    % feat / AutoFakeSlant   .tl_set:N   = \l__ztex_fontcfg_new_autofsl_tl,
    % feat / AutoFakeSlant   .default:n  = { true },
    % feat / AutoFakeSlant   .initial:n  = { false }, % false
  }
  ...
  {% #1:en/cn; #2:key-value(font cfg args)
    ...
    \__ztex_fontcfg_newfamily_copy:ooooo 
      ...
      { \l__ztex_fontcfg_new_name_tl }
      {
        ...
        % AutoFakeBold    = \l__ztex_fontcfg_new_autofbd_tl,
        % AutoFakeSlant   = \l__ztex_fontcfg_new_autofsl_tl,
      }{#1}
    % Reset key value, '\group_end:' conflict with '\newfontfamily',
    ...
    \ztex_keys_set:nn { fontcfg / new }
      {
        ...
        feat / bdsl = *,
        feat / bdit = *,
        % feat / AutoFakeBold  = false,
        % feat / AutoFakeSlant = false,
      }
  }
