\ProvidesExplFile{zlatex.module.thm.tex}{2025/01/20}{1.0.1}{thm~module~for~zlatex}
...
\def\@zlatexThmTitle{\__zlatex_thm_title:}
\def\@@zlatexThmTitle{\tl_use:N \g__zlatex_thm_title_tl}
...
\cs_new:Npn \__zlatex_thm_warp_start:nnn #1#2#3 {
  ...
  \def\thm@temp@name{#1}
  \__zlatex_thm_title_item:nnn {#1}{#2}{#3}
...
\cs_new:Npn \__zlatex_thm_title_item:nnn #1#2#3 {
...
\NewDocumentCommand{\zlatexThmTitleFormat}{sm}{
  \IfBooleanTF{#1}{
    \AddToHook{zlatex/thm/titleformat}
      {\cs_set:Npn \__zlatex_thm_title: {\group_begin:\noindent #2\group_end:}}
  }{
...
\zlatex_label_hook_preamble_last:nn {zlatex-thmptheorem-setup-inner}{
  ...
  \clist_map_inline:Nn \g__zlatex_thm_theorem_clist {
    ...
    \DeclareDocumentEnvironment{#1}{O{}}{
      ...
      \bool_if:NT \g__zlatex_thm_title_inline_bool {\__zlatex_thm_title:}   
