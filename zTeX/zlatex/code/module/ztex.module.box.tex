...
\NewDocumentCommand\zfbox{o}
  {
    \IfValueT{#1}{
      \ztex_keys_set:nn { box/enhance-fbox }{ #1 }
    }
    \zbox_item_collect:nnnw
      {
        \begin{zpic}
          [
            ...
            yoffset=-\dim_to_decimal:n {\dp\ztexcollectbox + \fboxsep + \fboxrule/2},
            width=\dim_to_decimal:n {\wd\ztexcollectbox + 2\fboxsep + 2\fboxrule}
          ]
          \zrectangle[
            ...
            (
              ...
              \dim_to_decimal:n {\ht\ztexcollectbox + \dp\ztexcollectbox + 2\fboxsep + \fboxrule}
            )
          \put
            (
              \dim_to_decimal:n {\wd\ztexcollectbox/2 + \fboxsep + \fboxrule/2},
              \dim_to_decimal:n {\dp\ztexcollectbox + \fboxsep + \fboxrule/2}
            ) { \clap{ \hbox{\vbox{\box_use:N \ztexcollectbox}}} }
        \end{zpic}
