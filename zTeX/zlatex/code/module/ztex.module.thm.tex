...
\ztex_msg_set:nn {mathEnv-style}
  {
    You~use~an~incorrect~MathEnv~style:~
    '\g__ztex_thm_style_tl',~
    All~valid~styles~are:'plain',~'leftbar',~
    'background',~'fancy',~'shadow',~'paris',~
    'lapsis',~'tcb',~'obsidian',~and~'elegant'.
  }
% thm counter
