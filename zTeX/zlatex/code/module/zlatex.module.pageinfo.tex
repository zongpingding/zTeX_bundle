\ProvidesExplFile{zlatex.module.pageinfo.tex}{2025/03/10}{1.0.1}{pageinfo~module~for~zlatex}
...
\bool_if:NTF \g__zlatex_slide_bool {
  ...
  \renewcommand{\maketitle}{
    ...
    \ztool_get_ht:Nn \l_tmpb_dim {\title@upper@box{}} 
