...
\SetKeys[texhigh/high]{gobble=auto, before-text+={\catcode`\ =10 \catcode`\"=12 }}
        ...
        \clist_put_right:Nn \l__ztex_doc_source_clist 
          {
            ...
            \tl_if_eq:nnTF {##1}{wolfram}
              {
                \texhighfile[lexer-catcode*={128}{151}{\$=0}]{../code/#1/ztikz.#1.##1.tex}
              }{
                \texhighfile{../code/#1/ztikz.#1.##1.tex}
              }
          }
      }
  }
