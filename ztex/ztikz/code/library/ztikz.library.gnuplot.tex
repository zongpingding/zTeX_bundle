\ProvidesExplFile{ztikz.library.gnuplot.tex}{2025/12/02}
  {1.0.0}{gnuplot~library~for~ztikz}
...
\NewDocumentCommand\Plot{ O{}m }
  {
    \group_begin:
    \ztikz_keys_set:nn { 2dplot } { domain=-5:5, style={color=black}, marker= }
...
\NewDocumentCommand\ContourPlot{ O{}m }
  {
    \group_begin:
    \ztikz_keys_set:nn { 2dplot } { domain={-5:5;}, style={color=black}, marker= }
    \ztikz_keys_set:nn { 2dplot } { #1 }
...
\NewDocumentCommand\ParamPlot{ O{domain=0:2*pi, style=black, marker=}m }
  {
    \group_begin:
    \ztikz_keys_set:nn { 2dplot } { domain=0:2*pi, style=black, marker= }
    \ztikz_keys_set:nn { 2dplot } { #1 }
...
\NewDocumentCommand\PolarPlot{ O{}m }
  {
    \group_begin:
    \ztikz_keys_set:nn { 2dplot } { domain=0:2*pi, style=black, marker= }
    \ztikz_keys_set:nn { 2dplot } { #1 }
