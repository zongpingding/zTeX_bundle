\ProvidesExplFile{ztikz.library.l3draw.tex}{2026/04/29}
...
% segement connect
\cs_new_eq:NN \zcapbutt   \draw_set_cap_butt:
\cs_new_eq:NN \zcaproun   \draw_set_cap_round:
\cs_new_eq:NN \zcaprect   \draw_set_cap_rectangle:
