\ProvidesExplFile{ztex.library.fancy.tex}
...
\zsecformat\chapter
  {
    ...
    code = {
      ...
      \begin{tikzpicture}[overlay, remember~ picture]
        ...
        % chapter head
        \fill[\l__ztex_fancy_chap_color_tl] (A) rectangle (stripES);
        \draw[draw=\l__ztex_fancy_chap_color_tl] (stripES)++(.25em, 4em)   -- ++(.75\paperwidth-3.25em, 0pt);
        \draw[draw=\l__ztex_fancy_chap_color_tl] (stripES)++(.25em, 1.5pt) -- ++(.75\paperwidth-3.25em, 0pt);
        \draw[draw=\l__ztex_fancy_chap_color_tl] (stripES)++(.25em, 0em)   -- ++(.75\paperwidth-3.25em, 0pt);
        ...
        \shade[top~ color=white, bottom~ color=\l__ztex_fancy_chap_color_tl!25] (sayingWN) 
          rectangle ++(1\paperwidth, 5pt);
        \shade[top~ color=\l__ztex_fancy_chap_color_tl!25, bottom~ color=white] 
          ($(sayingWN)+(0em, -.15\paperheight)$) 
          rectangle ++(1\paperwidth, -5pt);
