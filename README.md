...
```latex 
\_zslide_status_bar:nnnn  {<bar color Tag>}{<start point>}{<rule width>}{<rule height>}

\_zslide_status_info:nnnn {<head/foot>}{<start x-coor>}{<hbox width>}{<hbox content>}

\_zslide_metadate:n {<bar tag>}
```
